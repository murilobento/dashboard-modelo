...
export function CompanySettingsDialog({
  ...
  const maskIE = (value: string, uf: string) => {
    ...
    switch (uf.toUpperCase()) {
      ...
      case 'AL':
        return v
          .replace(/^(\d{2})(\d{6})(\d{1})/, '$1.$2.$3-$4')
          .substring(0, 11) // 24.123.456-7
      case 'AP':
        return v
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className='border-input focus-within:ring-ring flex h-9 w-full rounded-md border bg-transparent shadow-sm focus-within:ring-1'>
                              <div className='bg-muted text-muted-foreground flex items-center rounded-l-md border-r px-3 text-sm'>
                                https://
                              </div>
                              <Input
                                className='h-full rounded-l-none border-0 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0'
                                {...field}
                              />
                            </div>
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className='relative'>
                              <TikTokIcon className='text-muted-foreground absolute top-2.5 left-2.5 h-4 w-4' />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className='relative'>
                              <WhatsAppIcon className='text-muted-foreground absolute top-2.5 left-2.5 h-4 w-4' />
                              <Input
                                className='pl-9'
                                {...field}
                                onChange={(e) =>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className='relative'>
                              <Instagram className='text-muted-foreground absolute top-2.5 left-2.5 h-4 w-4' />
                              <Input className='pl-9' {...field} />
                            </div>
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className='relative'>
                              <Facebook className='text-muted-foreground absolute top-2.5 left-2.5 h-4 w-4' />
                              <Input className='pl-9' {...field} />
                            </div>
                          </FormControl>
                          <FormMessage />
